import { FaDiscord, FaEnvelope, FaWhatsapp } from "react-icons/fa";
                  ...
                  <div>
                    <div>
                      <h2
                        ...
                        data-aos="fade-right"
                      >
                        <FaWhatsapp className="fill-indigo-500 inline-block" />{" "}
                        Whatsapp
                      </h2>
                      <div
                    ...
                    <div>
                      ...
                      <ul className="list-disc ml-5 mt-1">
                        <li>
                          <a
                            href="kaushiksp.ao1@gmail.com"
                            className="hover:text-indigo-500"
                          >
                            kaushiksp.ao1@gmail.com
                          </a>{" "}
                          (main)
                        </li>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          className="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
                          type="email"
                          placeholder="kaushiksp.ao1@gmail.com"
                          name="email"
                          required
                        />
                      </div>
